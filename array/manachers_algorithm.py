...
class Solution(object):
    def longestPalindrome(self, s):
        ...
        while center < len(newString):
            ...
            while (
                center - expandedRadius >= 0
                and center + expandedRadius < len(newString)
                and newString[center - expandedRadius]
                == newString[center + expandedRadius]
            ):
        ...
        longestPanlidrome = newString[
            longestPalindromeCenter
            - palindromeRadii[longestPalindromeCenter] : longestPalindromeCenter
            + palindromeRadii[longestPalindromeCenter]
            + 1
        ]
